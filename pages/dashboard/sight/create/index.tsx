...
import SightFormCreate from "../../../../components/SightFormCreate";
...
function CreateSight({ session }: any) {
  firebaseClient();
    ...
    if (
      ...
      if (JSON.stringify(sight) != "[]") {
        return (
          <FlexContainer>
            <Head>
              <title>{t("common:dash-createsight")} | SocGo!</title>
            </Head>
            <Metadata />
            <motion.div
              exit={{ opacity: 0 }}
                ...
                <Stack direction={["column", "row"]} spacing={0}>
                    ...
                    <Stack h="100%">
                      <motion.div style={{ flex: 1 }} variants={fadeIn}>
                        <Box bg="brand.500" height="100%" width="100%">
                          <MapCreate sight={sight} setSight={setSight} />
                        </Box>
                      </motion.div>
                    </Stack>
                  </Box>
                  ...
                  >
                    <motion.div variants={fadeInUp}>
                      <Box p={6}>
                        <SightFormCreate sight={sight} setSight={setSight} />
                      </Box>
                    </motion.div>
                  </Box>
                </Stack>

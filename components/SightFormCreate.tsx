...
export default function SightFormCreate(sight: any, setSight: any) {
  ...
  function onSubmit(values: any) {
    if (
      sight.sight.location["x_"] > 90 ||
      sight.sight.location["x_"] < -90 ||
      sight.sight.location["N_"] > 180 ||
      sight.sight.location["N_"] < -180
    ) {
      toast({
        title: "An error has occured",
        description:
          "The coordinates have to be between -90 and 90 for latitude and -180 and 180 for longitude.",
        status: "error",
        duration: 9000,
        isClosable: true,
      });
      ...
      return new Promise<void>(async (resolve) => {
        await firebase
          ...
          .then(() => {
            toast({
              title: "Success",
              description: "Successfully created a sight.",
              status: "success",
              duration: 9000,
              isClosable: true,
            });

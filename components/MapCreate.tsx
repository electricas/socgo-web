...
export default function MapCreate(sight: any, setSight: any) {
  const GMap = () => {
    return (
      <GoogleMap
        defaultZoom={sight.sight.location["x_"] != 9999 ? 16 : 2}
        defaultCenter={{
          lat:
            sight.sight.location["x_"] != 9999 ? sight.sight.location["x_"] : 0,
          lng:
            sight.sight.location["N_"] != 9999 ? sight.sight.location["N_"] : 0,
        }}
        defaultOptions={{
